...
function TodoState() {
  ...
  return (
    <div className="page">
      <h1>TODO List <span className="todo-badge">State</span></h1>
      ...
      {filtered.length === 0 && <p className="todo-empty">{filter === 'All' ? 'No tasks yet. Add one above!' : `No ${filter.toLowerCase()} tasks.`}</p>}
    </div>
  );
}
